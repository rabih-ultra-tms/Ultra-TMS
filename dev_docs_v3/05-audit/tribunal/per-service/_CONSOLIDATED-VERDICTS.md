...
| ------- | ----- | -------- |
| AFFIRM | 0 | |
| MODIFY | 22 | Auth & Admin, Dashboard, CRM, Sales, TMS Core, Carriers, Accounting, Commission, Load Board, Customer Portal, Documents, Communication, Carrier Portal, Claims, Contracts, Agents, Credit, Factoring, Analytics, Workflow, Integration Hub, Search |
| REVERSE | 0 | |
| DEFER | 0 | |
