...
describe('ElasticsearchService', () => {
  it('searches globally', async () => {
    ...
    const result = await service.searchGlobal('a', 'tenant-1');
  ...
  it('searches entity', async () => {
    ...
    const result = await service.searchEntity('companies', 'tenant-1', 'a', { status: 'ACTIVE' });
  ...
  it('returns suggestions', async () => {
    ...
    const result = await service.suggest('a', 'tenant-1');
