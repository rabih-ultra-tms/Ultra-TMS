...
export const QUOTE_STATUSES = {
  DRAFT: {
    label: 'Draft',
    status: undefined as StatusColorToken | undefined,
    intent: undefined as Intent | undefined,
    className: 'bg-gray-100 text-gray-700 border-gray-300',
  },
  SENT: {
    label: 'Sent',
    status: 'transit' as StatusColorToken | undefined,
    intent: undefined as Intent | undefined,
    className: undefined as string | undefined,
  },
  VIEWED: {
    label: 'Viewed',
    status: 'tendered' as StatusColorToken | undefined,
    intent: undefined as Intent | undefined,
    className: undefined as string | undefined,
  },
  ACCEPTED: {
    label: 'Accepted',
    status: 'delivered' as StatusColorToken | undefined,
    intent: undefined as Intent | undefined,
    className: undefined as string | undefined,
  },
  CONVERTED: {
    label: 'Converted',
    status: undefined as StatusColorToken | undefined,
    intent: 'success' as Intent | undefined,
    className: undefined as string | undefined,
  },
  REJECTED: {
    label: 'Rejected',
    status: 'atrisk' as StatusColorToken | undefined,
    intent: undefined as Intent | undefined,
    className: undefined as string | undefined,
  },
  EXPIRED: {
    label: 'Expired',
    status: 'unassigned' as StatusColorToken | undefined,
    intent: undefined as Intent | undefined,
    className: undefined as string | undefined,
  },
} as const;
...
export const INVOICE_STATUSES = {
  ...
  PARTIAL: {
    label: 'Partial',
    status: undefined as StatusColorToken | undefined,
    intent: 'warning' as Intent | undefined,
    className: undefined as string | undefined,
  },
  PAID: {
    label: 'Paid',
...
export const JOURNAL_ENTRY_STATUSES = {
  ...
  VOID: {
    label: 'Void',
    status: undefined as StatusColorToken | undefined,
    intent: 'danger' as Intent | undefined,
    className: undefined as string | undefined,
  },
} as const;

export type JournalEntryStatusToken = keyof typeof JOURNAL_ENTRY_STATUSES;
