...
import { VoidInvoiceDialog } from '@/components/accounting/void-invoice-dialog';
import {
  InvoiceOverviewTab,
  InvoiceLineItemsTab,
  InvoicePaymentsTab,
...
export default function InvoiceDetailPage({
  ...
  const handleDownloadPdf = async () => {
    try {
      ...
      const blob = response as unknown as globalThis.Blob;
  ...
  return (
    <>
      <DetailPage
        ...
        subtitle={invoice?.customerName && `Customer: ${invoice.customerName}`}
        tags={
        ...
        breadcrumb={
          <span>Accounting / Invoices / {invoice?.invoiceNumber || '...'}</span>
        }
        tabs={tabs}
        isLoading={isLoading}
