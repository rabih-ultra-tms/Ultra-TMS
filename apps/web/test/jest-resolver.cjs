...
const MOCK_MAP = {
  ...
  "lib/hooks/tms/use-dispatch-ws": path.join(ROOT, "test/mocks/hooks-tms-dispatch-ws.ts"),
  "lib/hooks/tms/use-dispatch": path.join(ROOT, "test/mocks/hooks-tms-dispatch.ts"),
  "lib/hooks/tms/use-stops": path.join(ROOT, "test/mocks/hooks-tms-stops.ts"),
  "lib/hooks/tms/use-checkcalls": path.join(ROOT, "test/mocks/hooks-tms-checkcalls.ts"),
  "lib/hooks/tms/use-ops-dashboard": path.join(ROOT, "test/mocks/hooks-tms-ops-dashboard.ts"),
  "lib/hooks/tms/use-tracking": path.join(ROOT, "test/mocks/hooks-tms-tracking.ts"),
  "lib/hooks/tms/use-rate-confirmation": path.join(ROOT, "test/mocks/hooks-tms-rate-confirmation.ts"),
  "lib/hooks/communication/use-send-email": path.join(ROOT, "test/mocks/hooks-communication-send-email.ts"),
  ...
  "lib/hooks/use-auth": path.join(ROOT, "test/mocks/hooks-use-auth.ts"),
  "lib/socket/socket-provider": path.join(ROOT, "test/mocks/socket-provider.tsx"),
  "lib/socket/use-socket-status": path.join(ROOT, "test/mocks/hooks-socket-status.ts"),
  "lib/google-maps": path.join(ROOT, "test/mocks/google-maps-config.ts"),
