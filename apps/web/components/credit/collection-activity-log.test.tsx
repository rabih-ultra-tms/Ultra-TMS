...
describe('CollectionActivityLog', () => {
  it('should render loading state', () => {
    render(<CollectionActivityLog companyId="company-123" />, {
  ...
  it('should handle empty activity list', () => {
    render(<CollectionActivityLog companyId="company-no-activity" />, {
      wrapper: createWrapper(),
    });
  ...
  it('should be scrollable for many activities', () => {
    render(<CollectionActivityLog companyId="company-many-activities" />, {
      wrapper: createWrapper(),
    });
  ...
  it('should display error state on API failure', () => {
    render(<CollectionActivityLog companyId="invalid-id" />, {
      wrapper: createWrapper(),
    });
