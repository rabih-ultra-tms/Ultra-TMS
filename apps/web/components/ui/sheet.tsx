...
const SheetPortal = ({ className, ...props }: SheetPrimitive.DialogPortalProps & { className?: string }) => (
  <SheetPrimitive.Portal {...props}><div className={cn(className)} /></SheetPrimitive.Portal>
);
...
const sheetVariants = {
  ...
  right: "inset-y-0 right-0 h-full w-3/4 border-l sm:max-w-sm data-[state=open]:slide-in-from-right",
};
