              ...
              <Card key={moduleName} className={cn(
                ...
                <CardHeader className="p-0">
                  ...
                  >
                    ...
                    {/* Select All Actions - Only visible on hover or if expanded, to reduce clutter */}
                    <div className={cn("flex items-center pl-4 ml-4", isDark ? "border-gray-700" : "border-gray-200")} onClick={(e) => e.stopPropagation()}>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <div className={cn("flex items-center gap-2 cursor-pointer p-1.5 rounded-md transition-colors", isDark ? "hover:bg-slate-800" : "hover:bg-gray-100")} onClick={() => toggleModule(moduleName, !allSelected)}>
                                    <span className={cn("text-sm font-medium", isDark ? "text-gray-400" : "text-gray-600")}>All</span>
                                    <Checkbox
                                        checked={allSelected}
                                        className={cn("h-6 w-6 translate-y-[1px]", isDark ? "border-gray-600" : "border-gray-300")}
                                        ref={(el) => {
                                            if (el) {
                            ...
                            <TooltipContent>Select all in {moduleDisplayNames[moduleName]}</TooltipContent>
                        </Tooltip>
                    </div>
                  </div>
                </CardHeader>
                                    ...
                                    isDark 
                                      ...
                                      : "hover:bg-gray-100 text-gray-700"
                                        ...
                                        <Checkbox
                                          ...
                                          className={cn("h-6 w-6", isDark ? "border-gray-600" : "border-gray-300")}
                                        />
                                        <div className="flex-1 min-w-0">
                                          <p className={cn("text-base font-medium leading-none truncate transition-colors", isDark ? "group-hover/item:text-blue-400" : "group-hover/item:text-blue-600")}>
