...
import type { PaymentStatus, PaymentMethod } from "@/lib/hooks/accounting/use-payments";
...
export function PaymentFilters() {
  ...
  const method =
    (searchParams.get("method") as PaymentMethod | "all") || "all";
  ...
  const hasActiveFilters =
    status !== "all" || method !== "all" || !!search || !!fromDate || !!toDate;
