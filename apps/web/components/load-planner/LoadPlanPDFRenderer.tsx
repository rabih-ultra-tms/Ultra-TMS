 ...
 * LoadPlanPDFRenderer
 *
 * SVG rendering helpers for PDF generation. These functions return SVG strings
 * that can be converted to PNG for PDF embedding.
 */
...
export function calculateMaxHeightUsed(truck: TruckType, items: LoadItem[]): number {
