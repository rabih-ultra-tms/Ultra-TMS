...
function CarrierCard({
  ...
  const isCompliant =
    ...
    isInsuranceValid(carrier.insuranceExpiryDate);
    ...
    >
      ...
      <CardContent className="space-y-2 pb-3">
            ...
            <div>
              ...
              <span
                className={cn(
                  ...
                  scorecard.onTimePercentage >= 80 &&
                    scorecard.onTimePercentage < 90 &&
                    'text-amber-600',
            ...
            <div>
              ...
              <span
                className={cn(
                  ...
                  scorecard.claimsRate >= 1 &&
                    scorecard.claimsRate < 3 &&
                    'text-amber-600',
        ...
        <div className="flex items-center gap-2 flex-wrap text-xs">
          ...
          {carrier.insuranceExpiryDate && (
            <span className="text-muted-foreground">
              Insurance:{' '}
              {new Date(carrier.insuranceExpiryDate).toLocaleDateString()}
            </span>
          )}
        </div>
        ...
        {carrier.loadsCompleted !== undefined && (
          <div className="text-xs text-muted-foreground">
            {carrier.loadsCompleted} load
            {carrier.loadsCompleted !== 1 ? 's' : ''} completed
          </div>
        )}
      </CardContent>
...
function TierBadge({ tier }: { tier: string }) {
  ...
  return (
    <Badge
      variant="secondary"
      className={cn(variant.bg, variant.text, 'hover:bg-opacity-80')}
    >
      {tier}
    </Badge>
  );
